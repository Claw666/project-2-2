...
public class Game implements Runnable {
    ...
    public Game(GameMap gameMap, IAgentFactory agentFactory, final boolean queryIntent, int maxNumTicks)
    {
        this(gameMap, agentFactory, queryIntent, -1, null);
                ...
                Callback<Game> turnTickCallback)
    {
        ...
        // measurements for experiments
        this.maxNumTicks = Integer.MAX_VALUE; // default case, unless changed in constructor
        this.numTicks = 0;
                                                      ...
                                                      List<MapObject> avoid, List<PointContainer.Circle> occupied)
    {
        ...
        #########################
        ####
        #### not used to perform experiments with more than 4 agents in spawn area.
        ####
        #########################
    ...
    public void run()
    {
        ...
        // measurements for experiments after game end
